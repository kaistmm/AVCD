...
class AVQADataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        video_path = "/mnt/lynx1/datasets/AVQA/MUSIC-AVQA-videos-Real/" +sample["video_id"]+".mp4"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--video-folder', help='Directory containing video files.', default="/mnt/lynx1/datasets/AVQA/MUSIC-AVQA-videos-Real")
    parser.add_argument('--question-file', help='Path to the ground truth file containing question.', default="./json/avqa-test_real.json")
    parser.add_argument('--answer-file', help='Path to the ground truth file containing answers.', required=False)
    parser.add_argument('--output-file', help='Directory to save the model results JSON.', default="./MUSICAVQA_real.json") 

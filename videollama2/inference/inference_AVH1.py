...
def run_inference(args):
    ...
    dataset = AVH1(gt_questions, processor['video'], processor["audio"])
...
if __name__ == "__main__":
    ...
    parser.add_argument('--question-file', help='Path to the ground truth file containing question.', default="./json/Audio-driven_Video_Hallucination.json")
    parser.add_argument('--answer-file', help='Path to the ground truth file containing answers.', required=False)
    parser.add_argument('--output-file', help='Directory to save the model results JSON.', default="./AVCD_AVH1.json") #last2 
    ...
    parser.add_argument("--dataset", type=str, default="AVH1")

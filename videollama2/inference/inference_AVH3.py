...
def run_inference(args):
    ...
    dataset = AVH3(gt_questions, processor['video'], processor["audio"])
...
if __name__ == "__main__":
    ...
    parser.add_argument('--question-file', help='Path to the ground truth file containing question.', default="./json/AV_Matching.json")
    parser.add_argument('--answer-file', help='Path to the ground truth file containing answers.', required=False)
    parser.add_argument('--output-file', help='Directory to save the model results JSON.', default="./AVCD_AVH3.json") #last2 
    ...
    parser.add_argument("--dataset", type=str, default="AVH3")

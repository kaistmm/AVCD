...
def run_inference(args):
    ...
    dataset = AVH4(gt_questions, processor['video'], processor["audio"])
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output-file', help='Directory to save the model results JSON.', default="./AVCD_AVH4.json") #last2
    ...
    parser.add_argument("--dataset", type=str, default="AVH4")
